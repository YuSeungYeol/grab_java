...
import com.grab.common.Paging_admin;

public class HospiInfo extends Paging_admin{
    ...
    private LocalDateTime hospital_reg_date;
	...
	public HospiInfo(int hospital_no, String hospital_name, String hospital_phone, String hospital_addr,
			...
			String hospital_lunch_time, char hospital_whether, int hospital_view, LocalDateTime hospital_login,
			LocalDateTime hospital_reg_date) {
		super();
		...
		this.hospital_reg_date = hospital_reg_date;
	}
	...
	public LocalDateTime getHospital_login() {
		return hospital_login;
	}


	public void setHospital_login(LocalDateTime hospital_login) {
		this.hospital_login = hospital_login;
	}


	public LocalDateTime getHospital_reg_date() {
		return hospital_reg_date;
	}


	public void setHospital_reg_date(LocalDateTime hospital_reg_date) {
		this.hospital_reg_date = hospital_reg_date;
	}
	...
	public String toString() {
		return "관리자용 병원 정보 [hospital_no=" + hospital_no + ", hospital_name=" + hospital_name + ", hospital_phone="
				...
				+ hospital_login + ", hospital_reg_date=" + hospital_reg_date + "]";
	}
