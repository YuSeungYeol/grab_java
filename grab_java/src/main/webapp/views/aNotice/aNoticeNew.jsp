  ...
  <body>
        ...
        <div class="container">
          <div class="page-inner">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                <form action="<%=request.getContextPath()%>/notice/createEnd" name="create_notice_form" method="post">
                  <div class="card-header">
                    <div class="card-title">
                      <input type="text" name="notice_title" placeholder="제목을 입력하세요." style="width:100%; font-size:15px;">
                    </div>
                  </div>
                  <div class="card-body">
                    <textarea name="notice_content" rows="15" placeholder="내용을 입력하세요." style="resize:none; color:grey; width:100%; padding:0;"></textarea>
                    <div id="bottomOption" style=>
                      <div class="btnBox">
                        <input type=button class="btn btn-warning" onclick="createNoticeForm();" value="등록">
                      </div>
                    </div>
                  </div>
                  </form>
    ...
    <script type="text/javascript">
    	function createNoticeForm(){
    		let form = document.create_notice_form;
