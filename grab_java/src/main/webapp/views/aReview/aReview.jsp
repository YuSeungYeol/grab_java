                       ...
                       <%
                       	...
                       	for(int i=0; i<list.size(); i++){ %>
                       		<tr>
                       			...
                       			<td><a href="#"><%=list.get(i).getReview_content()%></a></td>
								...
								%>
                       			<td><%=formattedDate%></td>
                       			 ...
                       			 <% String reviewCheck = list.get(i).getReview_check().toLowerCase();
                       			 if("x".equals(reviewCheck)){%>
                       				<td><button class="btn btn-warning"><b>미확인</b></button></td>
                       			<%}else{%>
                       				<td><button class="btn btn-warning"><b>반려</b></button></td>
                       			<%}%>
