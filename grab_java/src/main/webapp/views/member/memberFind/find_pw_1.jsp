...
<head>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="../../../resources/common/bootstrap.min.css" type="text/css">
    <!--  <link rel="stylesheet" href="../../resources/css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="../../resources/css/elegant-icons.css" type="text/css">
    <link rel="stylesheet" href="../../resources/css/flaticon.css" type="text/css">
    <link rel="stylesheet" href="../../resources/css/owl.carousel.min.css" type="text/css">
    <link rel="stylesheet" href="../../resources/css/slicknav.min.css" type="text/css"> -->
    <link rel="stylesheet" href="../../../resources/member/memberFind/find_pw_1.css"
        type="text/css">
  </head>
     ...
     <div class="container">
        ...
        <div class="form-box">
            <div class="form-group">
                <label for="member-id" name="find-id">아이디</label>
                <input type="text" class="form-control" id="member-id">
            </div>
            <div class="form-group">
                <label for="member-email" class="pwpw" name="find-email">이메일</label>
                <input type="email" class="form-control" id="member-email">
            </div>
        </div>

        <div class="id-know">
            <p style="font-size: 13px;">아이디가 기억나지 않는다면?</p>
            <a href="<%=request.getContextPath()%>/views/member/memberFind/find_id_1.jsp">아이디 찾기</a>
        </div>

        <div class="button">
            <button id="button-next" onclick="FindPwdServlet()">다음</button>
        </div>
    </div>
        <!---------------------------------------------------------------------->
        <div class="footer">
