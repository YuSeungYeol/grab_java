    ...
    <div class="community">
        <div class="board_select">
            <ul class="notoSansMedium">
                ...
                <li class="bar"><a href="/information_share/list">병원 정보 공유</a></li>
            </ul>
        </div>
        <div class="communityBody width_size">
            <p class="notoSansMedium">병원 정보 공유</p>
            ...
            <button type="button" class="btn btn-light board_create">
                <a href="/send/create/board?boardType=3" class="notoSansMedium">
                    글 작성 
